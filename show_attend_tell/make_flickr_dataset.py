...
vgg_model = './models/vgg/VGG_ILSVRC_19_layers.caffemodel'
vgg_deploy = './models/vgg/VGG_ILSVRC_19_layers_deploy.prototxt'

annotation_path = './data2/results_20130124.token'
flickr_image_path = './image2/'
feat_path = './data2/feats.npy'
annotation_result_path = './data2/annotations.pickle'
